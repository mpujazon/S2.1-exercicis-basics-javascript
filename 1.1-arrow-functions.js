...
/*
    Exercici 4
    Funció de fletxa dins d'un loop: Crea una funció anomenada printNumbers que accepti un array
    de números i utilitzi un loop for per imprimir cada número a la consola utilitzant una funció de fletxa.
*/
const printNumbers = (numbersArray) => {
    Array.isArray(numbersArray)?
        ...
        :(console.log(`${numbersArray} isn't an array!`)
    )
}
...
const printMessage = () => {
    setTimeout(()=>{
        console.log("Message printed after waiting 3 seconds");
    },3000);
}
printMessage();